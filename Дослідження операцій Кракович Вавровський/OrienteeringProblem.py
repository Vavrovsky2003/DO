[1.2/5,1.5/5,0.1/5,0.3/5,0.9/5,0.2/5,1.1/5,3.3/5,3.5/5,3.5/5,1.8/5,5.2/5,8.9/5,7.2/5,3.1/5,2.9/5,2.9/5,1.5/5,3.4/5,0/5,4.9/5,2/5,2.6/5,0.7/5,0.6/5],
...
[7.5/5,7.9/5,8.8/5,9/5,9/5,8.9/5,9.3/5,10.4/5,9.9/5,6.3/5,7.5/5,7.3/5,6.4/5,7/5,9.6/5,10.3/5,9.6/5,8.9/5,10.5/5,8.6/5,6.2/5,9.3/5,0/5,9.3/5,9.1/5],
...
score=[10.0,10.0,8.0,8.0,8.0,8.0,7.0,7.0,8.0,8.0,10.0,7.0,7.0,0.0,5.0,0.0,0.0,2.0,0.0,6.0,0.0,5.0,6.0,6.0,7.0]
score1=[0.0,0.0,0.0,0.0,18.0,15.0,16.0,15.0,15.0,18.0,0.0,15.0,13.0,5.0,0.0,5.0,5.0,9.0,7.0,0.0,5.0,0.0,0.0,6.0,0.0]
        ...
        for i in range(25):
            for j in range(25):
                if on_foot_times[i][j] > on_foot_times[i][k] + on_foot_times[k][j]:
                    ...
                    next_nodes[i][j] = k
    return distances, next_nodes, times, duration_times, on_foot_times
...
distances, next_nodes, times, duration_times, on_foot_times = floyd_warshall(matrix_distances)
...
while len(visited) < len(matrix_distances):
    ...
    if int(time.strftime('%H')) < 5 or int(time.strftime('%H')) >= 23:
        if on_foot_times[current_node][next_node]<duration_times[current_node][next_node]:
            sum_time += on_foot_times[current_node][next_node]
            if sum_time > T_max:
                sum_time=sum_time-on_foot_times[current_node][next_node]
                sum_distance=sum_distance-distances[current_node][next_node]
                break
        elif on_foot_times[current_node][next_node]>duration_times[current_node][next_node]:
            sum_time += duration_times[current_node][next_node]
            if sum_time > T_max:
                sum_time=sum_time-duration_times[current_node][next_node]
                sum_distance=sum_distance-distances[current_node][next_node]
                break
    elif int(time.strftime('%H')) >= 5 and int(time.strftime('%H')) < 23:
        if on_foot_times[current_node][next_node]<times[current_node][next_node] and on_foot_times[current_node][next_node]<duration_times[current_node][next_node]:
            sum_time += on_foot_times[current_node][next_node]
            if sum_time > T_max:
                sum_time=sum_time-on_foot_times[current_node][next_node]
                sum_distance=sum_distance-distances[current_node][next_node]
                break
        elif duration_times[current_node][next_node]<times[current_node][next_node] and duration_times[current_node][next_node]<on_foot_times[current_node][next_node]:
            sum_time += duration_times[current_node][next_node]
            if sum_time > T_max:
                sum_time=sum_time-duration_times[current_node][next_node]
                sum_distance=sum_distance-distances[current_node][next_node]
                break
        elif times[current_node][next_node]<duration_times[current_node][next_node] and times[current_node][next_node]<on_foot_times[current_node][next_node]:   
            sum_time += times[current_node][next_node]
            if sum_time > T_max:
                sum_time=sum_time-times[current_node][next_node]
                sum_distance=sum_distance-distances[current_node][next_node]
                break
